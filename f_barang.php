        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">DataBarang</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">  
            <div class="card">
              <div class="card-header">
                ...
                <h3 class="card-title">Input Data Barang PT. Sejahtera</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <?php 
                    ...
                    ?>
              <form class="container form mt-3" method="POST" action="controllers/ControllerBarang.php">
